  ...
  return (
    <>
      <header className="bg-[#0162b1] h-20 flex justify-end items-center fixed top-0 left-0 w-full z-10 shadow-lg">
        <div className="mr-auto flex gap-5 p-3">
          <Image
            width={100}
            height={100}
            alt="Logo MBRAS"
      ...
      <main className="w-full h-[765px] relative overflow-hidden flex items-center justify-center">
        <video
        ...
        <div className="w-4xl h-2/4 relative ml-10 flex flex-col items-center rounded-3xl text-[#95cade]">
          <h1 className="text-5xl montserrat my-3">
          ...
          <div className="bg-[#ffffff51] w-3xl h-36  flex justify-center items-center px-2 rounded-lg mt-20 ">
